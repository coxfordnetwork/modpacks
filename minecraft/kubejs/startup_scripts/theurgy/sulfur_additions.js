  ...
  StartupEvents.registry("item", (allthemods) => {
    if (Platform.isLoaded("forbidden_arcanus")) {
      ...
      allthemods
        ...
        .sulfurType("metals")
      allthemods
        .create("arcane_sulfur", "theurgy:alchemical_sulfur")
        .sourceItem("forbidden_arcanus:arcane_crystal")
        .sourceName("Arcane Crystal")
        .derivativeTier("rare")
        .sulfurType("gems")
      allthemods
        .create("runic_sulfur", "theurgy:alchemical_sulfur")
    ...
    if (Platform.isLoaded("mysticalagriculture")) {
      allthemods
        .create("prosperity_sulfur", "theurgy:alchemical_sulfur")
    ...
    if (Platform.isLoaded("occultism")) {
      // Occultism
      allthemods
        .create("iesnium_sulfur", "theurgy:alchemical_sulfur")
    ...
    if (Platform.isLoaded("irons_spellbooks")) {
      // Irons
      allthemods
        .create("mithril_sulfur", "theurgy:alchemical_sulfur")
    ...
    if (Platform.isLoaded("silentgear")) {
      // Silent
      allthemods
        .create("bort_sulfur", "theurgy:alchemical_sulfur")
