...
StartupEvents.registry("block", (allthemods) => {
  ...
  allthemods
    .create("air_essence_block")
    .displayName("Air Essence Block")
    .stoneSoundType()
    .mapColor("stone")
    .hardness(0.6)
    ...
    .notSolid()
  allthemods
    .create("earth_essence_block")
    .displayName("Earth Essence Block")
    .stoneSoundType()
    .mapColor("stone")
    .hardness(0.6)
    .renderType("translucent")
    .notSolid()
  allthemods
    .create("fire_essence_block")
    .displayName("Fire Essence Block")
    .stoneSoundType()
    .mapColor("stone")
    .hardness(0.6)
    .renderType("translucent")
  ...
  allthemods
    .create("blaze_powder_block")
    .displayName("Blaze Powder Block")
    .stoneSoundType()
    .mapColor("stone")
    .hardness(1)
...
StartupEvents.registry("item", (allthemods) => {
  ...
  if (Platform.isLoaded("iceandfire")) {
    allthemods
      .create("fire_eye")
      .use((level, player, hand) => global.iceAndFirePearls(level, player, hand))
      .texture("kubejs:item/fire_eye")
    allthemods.create("fire_pearl").texture("kubejs:item/fire_pearl")
    allthemods
      .create("lightning_eye")
      .use((level, player, hand) => global.iceAndFirePearls(level, player, hand))
      .texture("kubejs:item/lightning_eye")
    allthemods.create("lightning_pearl").texture("kubejs:item/lightning_pearl")
    allthemods
      .create("ice_eye")
      .use((level, player, hand) => global.iceAndFirePearls(level, player, hand))
      .texture("kubejs:item/ice_eye")
    allthemods.create("ice_pearl").texture("kubejs:item/ice_pearl")
  }

  if (Platform.isLoaded("dysoncubeproject")) {
    allthemods
      .create("allthemodium_solar_sail_package")
      .displayName("Allthemodium Solar Sail Package")
      .component("dysoncubeproject:sphere_component_solar_sail", Java.cast("java.lang.Integer", 64))
    allthemods
      .create("allthemodium_beam_package")
      .displayName("Allthemodium Beam Package")
      .component("dysoncubeproject:sphere_component_beam", Java.cast("java.lang.Integer", 16))
  }
...
global.iceAndFirePearls = (
  /** @type {$ServerLevel_}} */ level,
  /** @type {$Player_}} */ player,
  /** @type {$InteractionHand_}} */ hand
) => {
  ...
  if (closest == null) {
    ...
    structureResult = serverChunkCache
      .getGenerator()
      .findNearestMapStructure(level, holderSet.get(), player.block.pos, radiusStructure, false)
  }
...
StartupEvents.registry("fluid", (allthemods) => {
  allthemods.create("liquid_souls", "thin").tint(0xc9eaff).displayName("Liquid Souls").noBlock()
