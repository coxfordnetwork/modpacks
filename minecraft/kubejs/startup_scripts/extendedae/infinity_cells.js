...
if (Platform.isLoaded("extendedae")) {
  StartupEvents.registry("item", (allthemods) => {
    ...
    // Lava
    allthemods
      .create("lava_cell", "custom_infinity_cell")
