...
ItemEvents.modifyTooltips((allthemods) => {
  ...
  allthemods.add(
    ["allthemodium:vibranium_ore", "allthemodium:other_vibranium_ore"],
    [
  ...
  allthemods.add("kubejs:silent_allthemodium_plate", [Text.of("§7§oIt's less... talkative now")])
  allthemods.add("kubejs:silent_vibranium_plate", [Text.of("§7§oIt's less... talkative now")])
  ...
  if (Platform.isLoaded("forbidden_arcanus")) {
    ...
    allthemods.add(/forbidden_arcanus:runic_[sd]/, [Text.of("§7Spawns at the bottom of the world up to Y 2")])
    allthemods.add(
      ["forbidden_arcanus:arcane_crystal_ore", "forbidden_arcanus:deepslate_arcane_crystal_ore"],
      [Text.of("§7Very rarely spawns between Y -40 and Y 14"), Text.of("§7Most common at Y -13")]
    )
    ...
    allthemods.add("forbidden_arcanus:crimson_stone", [Text.of("§aFound in Pillager Outposts")])
    ...
    allthemods.add("forbidden_arcanus:divine_pact", [Text.of("§aFound in the Village and Pyramid in The Other")])
    allthemods.add("forbidden_arcanus:maledictus_pact", [Text.of("§aFound in Treasure Bastions")])
  }
  ...
  if (Platform.isLoaded("easy_villagers")) {
    // Easy Villagers
    allthemods.add(
      ["easy_villagers:trader", "easy_villagers:auto_trader"],
