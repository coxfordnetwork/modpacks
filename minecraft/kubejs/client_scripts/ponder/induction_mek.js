...
if (Platform.isLoaded("ponder")) {
  Ponder.registry((allthemods) => {
    allthemods
      .create(["mekanism:induction_casing", "mekanism:induction_port"])
      ...
      .scene(
        ...
        (scene, util) => {
          ...
          scene
            .text(80, "The Induction Matrix is used to store tons of Power.", [0, 4.5, 4.5])
            .placeNearTarget()
            .attachKeyFrame()
          scene.idle(85)
          ...
          scene
            .text(80, "The Faces Can Be Either Casings Or Structural Glass.", [0, 2.5, 2.5])
            .placeNearTarget()
            .attachKeyFrame()
          ...
          scene
            .text(60, "Induction Cells Are Used To Increase Power Storage.", [2.5, 1.5, 2.5])
            .placeNearTarget()
            .attachKeyFrame()
          ...
          scene.idle(65)
          scene
            .text(60, "Induction Providers Are Used To Increase Power Transfer Rate.", [2.5, 2.5, 2.5])
            .placeNearTarget()
            .attachKeyFrame()
          ...
          scene
            .text(60, "The Matrix Must Have One Cell and One Provider.", [2, 2.5, 2.5])
            .placeNearTarget()
            .attachKeyFrame()
          scene.idle(65)
