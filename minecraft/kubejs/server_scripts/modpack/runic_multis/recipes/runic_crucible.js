    ...
    allthemods.recipes.modern_industrialization
      ...
      .itemIn(
        Platform.isLoaded("eternal_starlight")
          ? "4x eternal_starlight:trapped_soul"
          : 'ftbquests:missing_item[ftbquests:missing_item="eternal_starlight:trapped_soul"]'
      )
      .fluidIn("2500x starbunclemania:source_fluid")
      .itemOut("forbidden_arcanus:corrupt_soul")

    allthemods.recipes.modern_industrialization
      .runic_crucible(32, 150)
