...
ServerEvents.recipes((allthemods) => {
  ...
  if (Platform.isLoaded("mekanismtools")) {
    ...
    allthemods
      .shaped("mekanismtools:steel_pickaxe", ["SSS", " R ", " R "], {
        S: "#c:ingots/steel",
        R: "#c:rods/wooden"
      })
      .id("allthemods:mekanismtools/steel_pickaxe")
    allthemods
      .shaped("mekanismtools:steel_axe", ["SS ", "SR ", " R "], {
        S: "#c:ingots/steel",
        R: "#c:rods/wooden"
      })
      .id("allthemods:mekanismtools/steel_axe")
    allthemods
      .shaped("mekanismtools:steel_shovel", [" S ", " R ", " R "], {
        S: "#c:ingots/steel",
        R: "#c:rods/wooden"
      })
      .id("allthemods:mekanismtools/steel_shovel")
    allthemods
      .shaped("mekanismtools:steel_hoe", ["SS ", " R ", " R "], {
        S: "#c:ingots/steel",
        R: "#c:rods/wooden"
      })
      .id("allthemods:mekanismtools/steel_hoe")
    allthemods
      .shaped("mekanismtools:steel_paxel", ["APS", " R ", " R "], {
  ...
  if (Platform.isLoaded("the_bumblezone")) {
    allthemods
      .shaped("the_bumblezone:honey_crystal_shield", ["HSH", "HHH", " H "], {
        S: "minecraft:shield",
  ...
  if (Platform.isLoaded("twilightforest")) {
    allthemods
      .shaped("twilightforest:knightmetal_shield", ["KSK", "KKK", " K "], {
        S: "minecraft:shield",
  ...
  if (Platform.isLoaded("undergarden")) {
    allthemods
      .shaped("undergarden:cloggrum_shield", ["CSC", "CCC", " C "], {
        S: "minecraft:shield",
        C: "#c:ingots/cloggrum"
      })
