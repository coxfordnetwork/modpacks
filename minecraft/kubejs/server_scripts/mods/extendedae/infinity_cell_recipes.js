...
if (Platform.isLoaded("extendedae")) {
  ServerEvents.recipes((allthemods) => {
    function cell(output, item, typeA, typeB, component) {
      allthemods.shaped(output, ["GIG", "XCY", "AVU"], {
        G: "ae2:quartz_glass",
        I: item,
        X: typeA,
        C: component,
    ...
    if (Platform.isLoaded("allthecompressed")) {
      ...
      cell(
        "kubejs:moss_cell",
        "allthecompressed:moss_block_5x",
        "minecraft:bone_block",
        "minecraft:bone_block",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:andesite_cell",
        "allthecompressed:andesite_5x",
        "minecraft:water_bucket",
        "minecraft:lava_bucket",
        "megacells:cell_component_256m"
      )
      ...
      cell(
        "kubejs:end_stone_cell",
        "allthecompressed:end_stone_6x",
        "minecraft:purpur_block",
        "minecraft:purpur_block",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:netherrack_cell",
        "allthecompressed:netherrack_6x",
        "minecraft:lava_bucket",
        "minecraft:gravel",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:clay_cell",
        "allthecompressed:clay_5x",
        "minecraft:mud",
        "minecraft:mud",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:blackstone_cell",
        "allthecompressed:blackstone_6x",
        "minecraft:lava_bucket",
        "minecraft:blue_ice",
        "megacells:cell_component_256m"
      )
      ...
      cell(
        "kubejs:calcite_cell",
        "allthecompressed:calcite_5x",
        "minecraft:water_bucket",
        "minecraft:bone_block",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:cobbled_deepslate_cell",
        "allthecompressed:cobbled_deepslate_6x",
        "minecraft:lava_bucket",
        "minecraft:packed_ice",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:soul_sand_cell",
        "allthecompressed:soul_sand_6x",
        "allthemodium:soul_lava_bucket",
        "minecraft:sand",
        "megacells:cell_component_256m"
      )
      cell(
        "kubejs:sky_stone_cell",
        "allthecompressed:sky_stone_block_5x",
        "allthemodium:soul_lava_bucket",
        "ae2:sky_dust",
        "megacells:cell_component_256m"
      )
      ...
      cell(
        ...
        "allthecompressed:ancient_stone_5x",
        "allthemodium:soul_lava_bucket",
        "minecraft:lava_bucket",
        "megacells:cell_component_256m"
      )
