...
if (Platform.isLoaded("minecolonies")) {
  ServerEvents.recipes((event) => {
    ...
    event.shaped("minecolonies:supplychestdeployer", [" B ", "III", "RRR"], {
    ...
    event.shaped("minecolonies:supplycampdeployer", ["   ", "IBI", "RRR"], {
      B: "minecraft:white_banner",
      I: "minecraft:iron_bars",
      R: "#minecraft:chest_boats"
    })
    ...
    event.replaceInput(
      { input: "minecolonies:cabbage", mod: "minecolonies" },
      "minecolonies:cabbage",
      "#c:crops/cabbage"
    )
    // Bell Pepper replacement
    event.replaceInput(
      { input: "minecolonies:bell_pepper", mod: "minecolonies" },
      "minecolonies:bell_pepper",
      "#c:crops/bellpepper"
    )
    // Chickpea replacement
    event.replaceInput(
      { input: "minecolonies:chickpea", mod: "minecolonies" },
    ...
    event.replaceInput(
      { input: "minecolonies:eggplant", mod: "minecolonies" },
    ...
    // Soybean replacement
    event.replaceInput(
      { input: "minecolonies:soybean", mod: "minecolonies" },
    ...
    event.replaceInput(
      { input: "minecolonies:butternut_squash", mod: "minecolonies" },
      "minecolonies:butternut_squash",
      "#c:crops/wintersquash"
    )
    // Large Water Bottle replacement
    event.replaceInput(
      { input: "minecolonies:large_water_bottle", mod: "minecolonies" },
      "minecolonies:large_water_bottle",
      "#c:water/freshwater"
    )
    // Large Milk Bottle replacement
    event.replaceInput(
      { input: "minecolonies:large_milk_bottle", mod: "minecolonies" },
      "minecolonies:large_milk_bottle",
      "#c:milk"
    )
    // Large Soy Milk Bottle
    event.replaceInput(
      { input: "minecolonies:large_soy_milk_bottle", mod: "minecolonies" },
    ...
    event.replaceInput(
      { input: "minecolonies:cheddar_cheese", mod: "minecolonies" },
      "minecolonies:cheddar_cheese",
      "#c:cheese"
    )
    // Feta Cheese replacement
    event.replaceInput(
      { input: "minecolonies:feta_cheese", mod: "minecolonies" },
    ...
    event.replaceInput(
      { input: "minecolonies:tortillas", mod: "minecolonies" },
