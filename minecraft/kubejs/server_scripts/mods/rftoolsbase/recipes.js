...
if (Platform.isLoaded("rftoolsbase")) {
  ServerEvents.recipes((allthemods) => {
    ...
    // Fix Syringe Display
    allthemods
      .shaped(Item.of("rftoolsutility:flight_module", 1), ["DUD", "DND", "DPD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:blindness_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:featherfalling_module", 1), ["DUD", "DND", "DDD"], {
        D: "minecraft:feather",
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:haste_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:glowing_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:luck_module", 1), ["DUD", "DND", "DDD"], {
        D: "minecraft:quartz",
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:nightvision_module", 1), ["DUD", "DND", "DDD"], {
        D: "minecraft:glowstone",
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:noteleport_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:peaceful_module", 1), ["IUI", "DND", "IDI"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:poison_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:regeneration_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:saturation_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:slowness_module", 1), ["DUD", "DND", "DDD"], {
        D: "minecraft:string",
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:speed_module", 1), ["DUD", "DND", "DDD"], {
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:waterbreathing_module", 1), ["PUP", "DND", "PDP"], {
        D: "rftoolsbase:infused_enderpearl",
    ...
    allthemods
      .shaped(Item.of("rftoolsutility:weakness_module", 1), ["DUD", "DND", "DDD"], {
        D: "minecraft:cactus",
