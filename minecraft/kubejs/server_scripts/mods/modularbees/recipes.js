...
if (Platform.isLoaded("modularbees")) {
  ServerEvents.recipes((allthemods) => {
    ...
    allthemods
      .shaped(Item.of("modularbees:electrode_copper"), [" NG", " BN", "I  "], {
    ...
    allthemods
      .shaped(Item.of("modularbees:electrode_iron"), [" NG", " BN", "I  "], {
    ...
    allthemods
      .shaped(Item.of("modularbees:electrode_gold"), [" NG", " BN", "I  "], {
    ...
    allthemods
      .shaped(Item.of("modularbees:scented_plank", 4), ["NHN", "PPP", "NHN"], {
    ...
    allthemods
      .shaped(Item.of("modularbees:modular_beehive_core"), ["POP", "UBU", "PAP"], {
    ...
    allthemods
      .shaped(Item.of("modularbees:modular_beehive_part"), ["PPP", "PVP", "PPP"], {
        P: "modularbees:scented_plank",
    ...
    allthemods
      .shaped(Item.of("modularbees:modular_beehive_feeder"), [" P ", "PFP", " P "], {
    ...
    allthemods
      .shaped(Item.of("modularbees:modular_beehive_alveary"), ["EPE", "PNP", "EPE"], {
    ...
    allthemods
      .shaped(Item.of("modularbees:modular_beehive_overclocker"), ["PBP", "BOB", "PBP"], {
        P: "modularbees:modular_beehive_part",
        B: "minecraft:iron_bars",
        O: "productivelib:upgrade_productivity_4"
      })
